...
| The books look emptied in the Sheet | Another phone (an older copy of the app) pushed over it | Reload both phones, then press **🔄 Push app data to Sheet** on the phone that still shows the rows. On a computer: Google Sheets → **File → Version history → Restore this version**. Full order: HOW-IT-WORKS §12.2 |
